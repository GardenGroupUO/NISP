...
from NISP import __author__
project = u'NISP: The Nanocluster Interpolation Scheme Program'
...
latex_documents = [
    (master_doc, 'NISP.tex', u'The Nanoclusters Interpolation Scheme Program (NISP) Documentation',
...
man_pages = [
    (master_doc, 'NISP', u'The Nanoclusters Interpolation Scheme Program (NISP) Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NISP', u'The Nanoclusters Interpolation Scheme Program (NISP) Documentation',
     author, 'NISP', 'This program is designed to perform the interpolation scheme as designed in A. L. Garden, A. Pedersen, H. Jónsson, “Reassignment of ‘magic numbers’ of decahdral and FCC structural motifs”, Nanoscale, 10, 5124-5132 (2018).',
     'Research'),
]
