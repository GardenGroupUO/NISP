...
.. _Output_information_for_the_interpolation_scheme:
...
The NISP program will create a number of plots and text documents when it is run. See `Examples of data that the NISP program gives <Example_data_from_NISP>`_ to see the types of plots and text documents that NISP will make. 
